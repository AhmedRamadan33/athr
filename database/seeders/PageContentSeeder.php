...
class PageContentSeeder extends Seeder
{
    ...
    protected function defaults(): array
    {
        return [
            'home' => [
                'hero_eyebrow' => 'تشكيلة أثر المميزة',
                'hero_title' => 'لكل حضور',
            ...
            'story' => [
                ...
                'paragraph_3' => 'اليوم يمتد أثر عبر تشكيلة متنوعة من العطور الشرقية والغربية، لكن جوهرنا يبقى واحدًا: نصنع لحظة لا تُنسى مع كل رشة.',
                'image' => 'pages/story.jpg',
                'image_caption_line1' => 'من قلب الشرق',
                'image_caption_line2' => 'إلى حواس العالم',
                'value_1_title' => 'أصالة المكونات',
                'value_1_text' => 'نختار خاماتنا من أفضل مصادرها فى الشرق، من العود الكمبودى إلى الورد الطائفى.',
                'value_2_title' => 'حرفية فى كل تفصيلة',
                'value_2_text' => 'كل عطر يمر بمراحل تركيب دقيقة لضمان ثبات وتوازن الرائحة.',
                'value_3_title' => 'قصة تُروى',
                'value_3_text' => 'نؤمن أن كل عطر يجب أن يحمل حكاية، لا مجرد رائحة عابرة.',
            ],
            'ritual' => [
                'eyebrow' => 'طقوس العطر',
                'title' => 'اصنع لحظتك',
                ...
                'step_1_title' => 'اختر نقاط النبض',
                'step_1_text' => 'ضع العطر على نقاط النبض مثل الرسغين وخلف الأذن، فالحرارة هناك تُبرز رائحته بشكل أفضل.',
                'step_2_title' => 'لا تفرك، بل انتظر',
                'step_2_text' => 'اترك العطر يجف طبيعيًا فى الهواء بدل فركه، حتى لا تتغير تركيبة النوتات العطرية.',
                'step_3_title' => 'جدّد حضورك بعناية',
                'step_3_text' => 'رشة خفيفة عند الظهر تكفى لتجديد الأثر دون أن تطغى على رائحتك الأساسية.',
                'cta_label' => 'اكتشف الطقوس',
                'shop_cta_label' => 'تسوّق مجموعتنا',
            ],
            'contact' => [
