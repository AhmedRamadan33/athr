<div class="flex flex-col items-center justify-center text-center py-14 px-4">
    <div class="w-14 h-14 rounded-full bg-zinc-100 text-zinc-400 flex items-center justify-center mb-4">
    ...
    <p class="text-zinc-500 text-sm">{{ $message ?? 'لا توجد بيانات لعرضها' }}</p>
</div>
